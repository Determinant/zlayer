...
[geometry design](approach-geometry.md) defines those outcomes, while
[routes](README.md#anchored-approaches) describes their user-facing behavior.

## Contents

- [Recorded FAA 2609 results](#recorded-faa-2609-results)
- [Coverage work still open](#coverage-work-still-open)
- [Reviewed associations](#reviewed-associations)
- [Geometry lessons retained in the implementation](#geometry-lessons-retained-in-the-implementation)
- [Audit method and reproduction](#audit-method-and-reproduction)
- [Publication and saved editions](#publication-and-saved-editions)

## Recorded FAA 2609 results

The chart-matching audit below was recorded on **2026-09-20**, using FAA cycle **2609**,
...
The earlier [retained evidence](../../../docs/evidence/approaches/2026-09-20/README.md) contains
...
The September 21 review checked outbound FA course capture, preservation of known
maneuver prefixes after a failed intercept, and prescribed FC distances before
reversals. The shared [geometry policy](approach-geometry.md#interpret-legs-in-sequence)
owns those rules. The independent chart audit grants a detour allowance only after
checking that the coded outbound distance is drawn; unexplained detours remain
reviewable. [Maneuver evidence](../../../docs/evidence/approaches/2026-09-21/maneuver-review/README.md)
retains the plate cases, desktop/phone screenshots, source and implementation hashes,
and reproduction commands.

For the recorded FAA 2609 input, the interpreter reported diagnostics on 187 of
37,836 approach entries across 10,234 procedures, down from 201 with no newly
flagged entries. SID review entries remained 91 and STAR review entries zero;
manual endings were counted separately. Independent chart screening covered
34,214 chart/entry combinations: warning entries fell from 134 to 125, with none
marked complete. These are later geometry results, not a recalculation of the
September 20 chart-coverage percentages or proof of national plate equivalence.

Unresolved cases retained from that review:

| Case | Remaining work |
| --- | --- |
| [KCOE ILS/LOC 6](https://aeronav.faa.gov/d-tpp/2609/00527IL6.PDF) | The climb and COE R-350 outbound course are preserved, but the constrained return remains a gap. The planning connection starts at the known prefix's endpoint; retaining that prefix does not complete the maneuver. |
| [KLAN ILS/LOC 28L](https://aeronav.faa.gov/d-tpp/2609/00224IL28L.PDF) | The reviewed plate specifies a left missed turn, while the local CIFP export codes a valid right turn on the CF to UNSUN. Investigate the source discrepancy; the interpreter retains the gap rather than overriding the source. |
| KLPR ILS/LOC 7 | Successive left turns retain a crossing-review warning requiring source/geometry review. |

Altitude-terminated distances and turn radii remain illustrative, with no
aircraft-performance calculation. Source-record completeness does not establish
complete or operationally validated geometry.
...
Browser regressions exercise preview, save and reload at 320/1280 px, including
rejected helicopter collisions and explicit parallel-runway selection. Dated
audit evidence does not replace the current
[full verification gate](../../../docs/development/local-development.md#verification). Run per-cycle
