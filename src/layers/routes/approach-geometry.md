...
- [One pipeline, three geometry outcomes](#one-pipeline-three-geometry-outcomes)
- [Preserve the information that defines a leg](#preserve-the-information-that-defines-a-leg)
- [Interpret legs in sequence](#interpret-legs-in-sequence)
- [Keep availability separate from geometry](#keep-availability-separate-from-geometry)
- [Implementation and data compatibility](#implementation-and-data-compatibility)
- [Acceptance cases and release evidence](#acceptance-cases-and-release-evidence)
...
The [KVGT regression and national screening](../../../docs/evidence/approaches/2026-09-21/intercept-capture/README.md)
