# Superseded magnetic drift aid

The former 20-second yaw-bias-only implementation has been replaced by
[relative magnetic vector fusion](magnetic-fusion.md). Raw vectors now directly
