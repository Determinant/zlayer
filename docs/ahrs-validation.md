...
[feature guide](../src/layers/ahrs/README.md) and its estimator notes. This page owns
...
[gravity/acceleration](../src/layers/ahrs/estimator/gravity-aiding.md),
[magnetic fusion](../src/layers/ahrs/estimator/magnetic-fusion.md),
[heading alignment](../src/layers/ahrs/estimator/heading-alignment.md) and
[yaw-independent velocity-change](../src/layers/ahrs/estimator/velocity-change.md)
...
remain in [deployment readiness](deployment-readiness.md#verification-and-remaining-release-gates).
For scrolling freezes and retained buffers, see
[AHRS memory and scrolling](memory-resources.md#ahrs-session-memory-and-scrolling).
...
The [recording and replay contract](../src/layers/ahrs/recording.md) describes
...
[browser verification guide](local-development.md#verification).
